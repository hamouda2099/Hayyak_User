...
class Orders {
  ...
  factory Orders.fromJson(Map<String, dynamic> json) => Orders(
    upcomingOrders: json["upcomingOrders"] == null ? [] : List<dynamic>.from(json["upcomingOrders"]!.map((x) => x)),
    pastOrders: json["pastOrders"] == null ? [] : List<PastOrder>.from(json["pastOrders"]!.map((x) => PastOrder.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "upcomingOrders": upcomingOrders == null ? [] : List<dynamic>.from(upcomingOrders!.map((x) => x)),
    "pastOrders": pastOrders == null ? [] : List<dynamic>.from(pastOrders!.map((x) => x.toJson())),
  };
}
