        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Consumer(
                builder: (context, watch, child) {
                  final refundGuarantee = watch(refundGuaranteeProvider).state;
                  return Row(
                    children: [
                      IconButton(
                        onPressed: () {
                      ...
                      IconButton(
                        onPressed: () {
                          if (sendMeTicketsVisSms == false) {
                            context.read(sendMeTicketsVisSmsProvider).state =
                                true;
                          } else {
                            context.read(sendMeTicketsVisSmsProvider).state =
                                false;
              ...
              Padding(
                padding:
                    EdgeInsets.only(left: 20.0, right: 20, top: 5, bottom: 5),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const [
                    Text(
