...
class CheckoutScreen extends StatelessWidget {
  CheckoutScreen({required this.eventName,required this.eventImage,required this.eventDate,required this.eventTime,required this.selectedTickets,required this.selectedServices});
  CheckoutLogic logic = CheckoutLogic();
 late String eventName, eventImage, eventDate, eventTime;
