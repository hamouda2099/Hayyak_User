                    ...
                    default:
                      if (snapShot.hasError) {
                        ...
                        return Consumer(builder: (context,ref,child){
                          ...
                          final whats = ref.watch(sendMeTicketsVisWhatsappProvider);
                                    ...
                                    onTap: () {
                                      if (snapShot.data?.data?.ticketsInvoice ==
                                        ...
                                        logic.createOrder(
                                            ...
                                            refund: 'on',
                                            whatsapp: 'on',
                                            amount:logic.countReceipt(sms, whats, refund)!.toStringAsFixed(2).toString(),
                                            date: selectedDate,
                                            couponId: '');
                                      }
                                    },
                                          ...
                                          InkWell(
                                            ...
                                            child: const Text(
                                              ...
                                              style: TextStyle(
                                                ...
                                                logic.staticServices?.data?.refund ==
                                                    null
                                                    ? const SizedBox()
                                                    : Padding(
                                                  padding:
